...
set(CMAKE_C_COMPILE_OBJECT "<CMAKE_C_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -o <OBJECT> -l <OBJECT>.s -c <SOURCE>")
set(CMAKE_C_CREATE_STATIC_LIBRARY "<CMAKE_AR> a <TARGET> <LINK_FLAGS> <OBJECTS>")
set(CMAKE_C_FLAGS "--cpu 65c02 --target none")
set(CMAKE_C_FLAGS_DEBUG_INIT "-O")
set(CMAKE_C_FLAGS_RELEASE_INIT "-Oirs")
set(CMAKE_C_LINK_FLAGS "${CMAKE_C_FLAGS} -C ${CMAKE_CURRENT_LIST_DIR}/rp6502.cfg")
